...
namespace SimplePay\Vendor\Symfony\Component\CssSelector\Tests\Parser;
...
class ParserTest extends TestCase
{
    ...
    public function testParseSeriesException($series)
    {
        ...
        /** @var FunctionNode $function */
        $function = $selectors[0]->getTree();
        $this->expectException('SimplePay\Vendor\Symfony\Component\CssSelector\Exception\SyntaxErrorException');
