...
namespace SimplePay\Vendor\Symfony\Component\CssSelector\Tests\XPath;
...
use SimplePay\Vendor\Symfony\Component\CssSelector\XPath\XPathExpr;
...
class TranslatorTest extends TestCase
{
    ...
    {
        $this->expectException('SimplePay\Vendor\Symfony\Component\CssSelector\Exception\ExpressionErrorException');
        $translator = new Translator();
        $translator->registerExtension(new HtmlExtension($translator));
