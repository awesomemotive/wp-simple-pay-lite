...
namespace SimplePay\Vendor\Symfony\Component\CssSelector\XPath;

use SimplePay\Vendor\Symfony\Component\CssSelector\Exception\ExpressionErrorException;
use SimplePay\Vendor\Symfony\Component\CssSelector\Node\FunctionNode;
use SimplePay\Vendor\Symfony\Component\CssSelector\Node\NodeInterface;
use SimplePay\Vendor\Symfony\Component\CssSelector\Node\SelectorNode;
use SimplePay\Vendor\Symfony\Component\CssSelector\Parser\Parser;
use SimplePay\Vendor\Symfony\Component\CssSelector\Parser\ParserInterface;
...
class Translator implements TranslatorInterface
{
    ...
    public function addAttributeMatching(XPathExpr $xpath, string $operator, string $attribute, ?string $value): XPathExpr
    {
        if (!isset($this->attributeMatchingTranslators[$operator])) {
            throw new ExpressionErrorException(sprintf('SimplePay_Attribute matcher operator "%s" not supported.', $operator));
        }
