 ...
 * @since       1.0.0
 */
namespace SimplePay\Vendor\BerlinDB\Database;
...
class Query extends Base {
	 ...
	 * @var   string
	 */
	protected $table_schema = '\\SimplePay\Vendor\BerlinDB\\Database\\Schema';
	 ...
	 * @var   mixed
	 */
	protected $item_shape = '\\SimplePay\Vendor\BerlinDB\\Database\\Row';
