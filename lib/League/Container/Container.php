...
use SimplePay\Vendor\League\Container\Argument\RawArgumentInterface;
use SimplePay\Vendor\League\Container\Definition\DefinitionFactory;
use SimplePay\Vendor\League\Container\Definition\DefinitionFactoryInterface;
use SimplePay\Vendor\League\Container\Definition\DefinitionInterface;
use SimplePay\Vendor\League\Container\Exception\NotFoundException;
use SimplePay\Vendor\League\Container\Inflector\InflectorAggregate;
use SimplePay\Vendor\League\Container\Inflector\InflectorAggregateInterface;
use SimplePay\Vendor\League\Container\ServiceProvider\ServiceProviderAggregate;
use SimplePay\Vendor\League\Container\ServiceProvider\ServiceProviderAggregateInterface;

class Container implements ContainerInterface
{
    /**
     * @var \SimplePay\Vendor\League\Container\Definition\DefinitionFactoryInterface
     */
    protected $definitionFactory;

    /**
     * @var \SimplePay\Vendor\League\Container\Definition\DefinitionInterface[]
     */
    ...
    /**
     * @var \SimplePay\Vendor\League\Container\Inflector\InflectorAggregateInterface
     */
    protected $inflectors;

    /**
     * @var \SimplePay\Vendor\League\Container\ServiceProvider\ServiceProviderAggregateInterface
     */
    protected $providers;
     ...
     * Constructor.
     *
     * @param \SimplePay\Vendor\League\Container\ServiceProvider\ServiceProviderAggregateInterface|null $providers
     * @param \SimplePay\Vendor\League\Container\Inflector\InflectorAggregateInterface|null             $inflectors
     * @param \SimplePay\Vendor\League\Container\Definition\DefinitionFactoryInterface|null             $definitionFactory
     */
