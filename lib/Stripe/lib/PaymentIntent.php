 ...
 * @property \SimplePay\Vendor\Stripe\StripeObject $amount_details
 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $transfer_data The data with which to automatically create a Transfer when the payment is finalized. See the PaymentIntents <a href="https://stripe.com/docs/payments/connected-accounts">use case for connected accounts</a> for details.
...
class PaymentIntent extends ApiResource
{
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\SearchResult<PaymentIntent> the payment intent search results
     */
