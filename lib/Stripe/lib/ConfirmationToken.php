...
/**
 * ConfirmationTokens help transport client side data collected by SimplePay\Vendor\Stripe JS over
 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $mandate_data Data used for generating a Mandate.
 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $payment_method_options Payment-method-specific configuration for this ConfirmationToken.
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $payment_method_preview Payment details collected by the Payment Element, used to create a PaymentMethod when a PaymentIntent or SetupIntent is confirmed with this ConfirmationToken.
 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $shipping Shipping information collected on this ConfirmationToken.
 * @property bool $use_stripe_sdk Indicates whether the SimplePay\Vendor\Stripe SDK is used to handle confirmation flow. Defaults to <code>true</code> on ConfirmationToken.
 */
