 ...
 *
 * If your invoice is configured to be billed through automatic charges, SimplePay\Vendor\Stripe
 ...
 * automatic</a>, does not happen immediately as the invoice is created. SimplePay\Vendor\Stripe
 * waits until one hour after the last webhook was successfully sent (or the last
 * webhook timed out after failing). If you (and the platforms you may have
 * connected to) have no webhooks configured, SimplePay\Vendor\Stripe waits one hour after creation
 ...
 * settings</a>, SimplePay\Vendor\Stripe will email the invoice to your customer and await payment.
 * These emails can contain a link to a hosted page to pay the invoice.
 *
 * SimplePay\Vendor\Stripe applies any customer credit on the account before determining the amount
 ...
 * @property \SimplePay\Vendor\Stripe\Collection $lines The individual line items that make up the invoice. <code>lines</code> is sorted as follows: invoice items in reverse chronological order, followed by the subscription, if any.
...
class Invoice extends ApiResource
{
     ...
     *
     * @return \SimplePay\Vendor\Stripe\Collection the list of lines (InvoiceLineItem)
     */
