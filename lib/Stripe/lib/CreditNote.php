 ...
 * @property \SimplePay\Vendor\Stripe\Collection $lines Line items that make up the credit note
...
class CreditNote extends ApiResource
{
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Collection the list of credit note line items
     */
