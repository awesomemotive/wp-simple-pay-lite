 ...
 * @property null|string|\SimplePay\Vendor\Stripe\CustomerBalanceTransaction $customer_balance_transaction Customer balance transaction related to this credit note.
 ...
 * @property \SimplePay\Vendor\Stripe\StripeObject[] $discount_amounts The aggregate amounts calculated per discount for all line items.
 ...
 * @property string|\SimplePay\Vendor\Stripe\Invoice $invoice ID of the invoice.
 * @property \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\CreditNoteLineItem> $lines Line items that make up the credit note
...
class CreditNote extends ApiResource
{
     ...
     *
     * @return \SimplePay\Vendor\Stripe\CreditNote the previewed credit note
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\CreditNoteLineItem> list of credit note line items
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\CreditNote the voided credit note
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\CreditNoteLineItem> the list of credit note line items
     */
