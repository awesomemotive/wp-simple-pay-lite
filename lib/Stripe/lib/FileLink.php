...
/**
 * To share the contents of a <code>File</code> object with non-SimplePay\Vendor\Stripe users, you can
 ...
 * @property string|\SimplePay\Vendor\Stripe\File $file The file object this link points to.
...
class FileLink extends ApiResource
{
     ...
     *
     * @return \SimplePay\Vendor\Stripe\FileLink the created resource
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\FileLink> of ApiResources
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\FileLink
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\FileLink the updated resource
     */
