...
class Stripe
{
    /** @var string The SimplePay\Vendor\Stripe API key to be used for requests. */
    public static $apiKey;

    /** @var string The SimplePay\Vendor\Stripe client_id to be used for Connect requests. */
    public static $clientId;

    /** @var string The base URL for the SimplePay\Vendor\Stripe API. */
    public static $apiBase = 'https://api.stripe.com';

    /** @var string The base URL for the OAuth API. */
    public static $connectBase = 'https://connect.stripe.com';

    /** @var string The base URL for the SimplePay\Vendor\Stripe API uploads endpoint. */
    public static $apiUploadBase = 'https://files.stripe.com';

    /** @var string The version of the SimplePay\Vendor\Stripe API to use for requests. */
    public static $apiVersion = \SimplePay\Vendor\Stripe\Util\ApiVersion::CURRENT;
    ...
    /** @var float Maximum delay between retries, in seconds, that will be respected from the SimplePay\Vendor\Stripe API */
    ...
    /**
     * @return null|string The SimplePay\Vendor\Stripe account ID for connected account
     *   requests
     */
    ...
    /**
     * @return float Maximum delay between retries, in seconds, that will be respected from the SimplePay\Vendor\Stripe API
     */
     ...
     *
     * Client telemetry enables timing and request metrics to be sent back to SimplePay\Vendor\Stripe as an HTTP Header
     * with the current request. This enables SimplePay\Vendor\Stripe to do latency and metrics analysis without adding extra
