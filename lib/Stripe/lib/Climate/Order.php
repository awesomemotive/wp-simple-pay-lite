...
namespace SimplePay\Vendor\Stripe\Climate;
 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $beneficiary
 ...
 * @property \SimplePay\Vendor\Stripe\StripeObject[] $delivery_details Details about the delivery of carbon removal for this order.
 ...
 * @property string|\SimplePay\Vendor\Stripe\Climate\Product $product Unique ID for the Climate <code>Product</code> this order is purchasing.
 ...
 */
class Order extends \SimplePay\Vendor\Stripe\ApiResource
{
     ...
     * processed immediately after creation and payment will be deducted your SimplePay\Vendor\Stripe
     * balance.
     *
     ...
     *
     * @return \SimplePay\Vendor\Stripe\Climate\Order the created resource
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\Climate\Order> of ApiResources
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Climate\Order
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Climate\Order the updated resource
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Climate\Order the canceled order
     */
