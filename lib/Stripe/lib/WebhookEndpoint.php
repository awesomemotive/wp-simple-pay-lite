 ...
 * notified about events that happen in your SimplePay\Vendor\Stripe account or connected
 * accounts.
 *
...
class WebhookEndpoint extends ApiResource
{
     ...
     *
     * @return \SimplePay\Vendor\Stripe\WebhookEndpoint the created resource
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\WebhookEndpoint the deleted resource
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\WebhookEndpoint> of ApiResources
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\WebhookEndpoint the updated resource
     */
