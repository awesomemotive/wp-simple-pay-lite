 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $currency_conversion Currency conversion details for automatic currency conversion sessions
 * @property \SimplePay\Vendor\Stripe\StripeObject[] $custom_fields Collect additional information from your customer using custom fields. Up to 2 fields are supported.
 ...
 * @property null|string $redirect_on_completion Applies to Checkout Sessions with <code>ui_mode: embedded</code>. By default, SimplePay\Vendor\Stripe will always redirect to your return_url after a successful confirmation. If you set <code>redirect_on_completion: 'if_required'</code>, then we will only redirect if your user chooses a redirect-based payment method.
 ...
 * @property null|string|\SimplePay\Vendor\Stripe\SetupIntent $setup_intent The ID of the SetupIntent for Checkout Sessions in <code>setup</code> mode.
