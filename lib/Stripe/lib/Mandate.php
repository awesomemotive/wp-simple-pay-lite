 ...
 * @property \SimplePay\Vendor\Stripe\StripeObject $customer_acceptance
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property \SimplePay\Vendor\Stripe\StripeObject $multi_use
 * @property string|\SimplePay\Vendor\Stripe\PaymentMethod $payment_method ID of the payment method associated with this mandate.
 * @property \SimplePay\Vendor\Stripe\StripeObject $payment_method_details
 * @property \SimplePay\Vendor\Stripe\StripeObject $single_use
