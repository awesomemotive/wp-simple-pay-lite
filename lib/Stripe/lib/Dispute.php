 ...
 * @property \SimplePay\Vendor\Stripe\BalanceTransaction[] $balance_transactions List of zero, one, or two balance transactions that show funds withdrawn and reinstated to your SimplePay\Vendor\Stripe account as a result of this dispute.
 * @property string|\SimplePay\Vendor\Stripe\Charge $charge ID of the charge that's disputed.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property \SimplePay\Vendor\Stripe\StripeObject $evidence
 * @property \SimplePay\Vendor\Stripe\StripeObject $evidence_details
 * @property bool $is_charge_refundable If true, it's still possible to refund the disputed payment. After the payment has been fully refunded, no further funds are withdrawn from your SimplePay\Vendor\Stripe account as a result of this dispute.
 ...
 * @property null|string|\SimplePay\Vendor\Stripe\PaymentIntent $payment_intent ID of the PaymentIntent that's disputed.
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $payment_method_details
...
class Dispute extends ApiResource
{
     ...
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\Dispute> of ApiResources
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Dispute the updated resource
     */
