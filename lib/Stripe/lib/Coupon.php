 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $currency_options Coupons defined in each available currency option. Each key must be a three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a> and a <a href="https://stripe.com/docs/currencies">supported currency</a>.
...
class Coupon extends ApiResource
{
     ...
     * SimplePay\Vendor\Stripe dashboard. Coupon creation is also accessible via the API if you need to
     ...
     *
     * @return \SimplePay\Vendor\Stripe\Coupon the created resource
     */
     ...
     * href="https://dashboard.stripe.com/coupons">coupon management</a> page of the
     * SimplePay\Vendor\Stripe dashboard. However, deleting a coupon does not affect any customers who
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Coupon the deleted resource
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\Coupon> of ApiResources
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Coupon the updated resource
     */
