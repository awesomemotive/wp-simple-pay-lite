...
class ChargeService extends \SimplePay\Vendor\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\Charge>
     */
     ...
     * will occur as if in live mode. (SimplePay\Vendor\Stripe assumes that the charge would have
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\SearchResult<\SimplePay\Vendor\Stripe\Charge>
     */
