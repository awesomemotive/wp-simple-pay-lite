 ...
 */
class InvoiceService extends \SimplePay\Vendor\Stripe\Service\AbstractService
{
    /**
    ...
    /**
     * SimplePay\Vendor\Stripe automatically finalizes drafts before sending and attempting payment on
    ...
    /**
     * SimplePay\Vendor\Stripe automatically creates and then attempts to collect payment on invoices
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\SearchResult<\SimplePay\Vendor\Stripe\Invoice>
     */
    ...
    /**
     * SimplePay\Vendor\Stripe will automatically send invoices to customers according to your <a
     * href="https://dashboard.stripe.com/account/billing/automatic">subscriptions
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\InvoiceLineItem
     */
     ...
     * href="#create_credit_note">credit note</a> instead. SimplePay\Vendor\Stripe recommends that you
