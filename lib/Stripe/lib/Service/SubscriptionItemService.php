...
class SubscriptionItemService extends \SimplePay\Vendor\Stripe\Service\AbstractService
{
    /**
     ...
     * with a quantity.
     *
     * Usage records provide <code>quantity</code> information that SimplePay\Vendor\Stripe uses to
     ...
     * billing</a> plan, SimplePay\Vendor\Stripe helps you send accurate invoices to your customers.
     *
     ...
     * there is more than one usage record with the same timestamp, SimplePay\Vendor\Stripe adds the
