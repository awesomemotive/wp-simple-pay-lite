...
class ApplicationFeeService extends \SimplePay\Vendor\Stripe\Service\AbstractService
{
    /**
     ...
     * refunded. Funds will be refunded to the SimplePay\Vendor\Stripe account from which the fee was
