 ...
 */
class InvoiceRenderingTemplateService extends \SimplePay\Vendor\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\InvoiceRenderingTemplate>
     */
     ...
     * SimplePay\Vendor\Stripe objects (customers, invoices, etc.) can reference it. The template can
     * also no longer be updated. However, if the template is already set on a SimplePay\Vendor\Stripe
    ...
    /**
     * Unarchive an invoice rendering template so it can be used on new SimplePay\Vendor\Stripe objects
     * again.
     *
     * @param string $id
     * @param null|array $params
