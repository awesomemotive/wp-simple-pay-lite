...
class PayoutService extends \SimplePay\Vendor\Stripe\Service\AbstractService
{
     ...
     * SimplePay\Vendor\Stripe has sent you. The payouts are returned in sorted order, with the most
     ...
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\Payout>
     */
     ...
     * href="#balance">SimplePay\Vendor\Stripe balance</a> must be able to cover the payout amount, or
     ...
     *
     * If you are creating a manual payout on a SimplePay\Vendor\Stripe account that uses multiple
     ...
     * either a payout creation request or the payout list, and SimplePay\Vendor\Stripe will return the
