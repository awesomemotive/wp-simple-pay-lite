...
namespace SimplePay\Vendor\Stripe\HttpClient;

use SimplePay\Vendor\Stripe\Exception;
use SimplePay\Vendor\Stripe\Stripe;
use SimplePay\Vendor\Stripe\Util;
...
class CurlClient implements ClientInterface, StreamingClientInterface
{
    ...
    /** @var \SimplePay\Vendor\Stripe\Util\RandomGenerator */
     ...
     * @param null|\SimplePay\Vendor\Stripe\Util\RandomGenerator $randomGenerator
     */
     ...
     *   <li>\SimplePay\Vendor\Stripe\Util\CaseInsensitiveArray $rheaders The response headers</li>
    ...
    private function handleCurlError($url, $errno, $message, $numRetries)
    {
        switch ($errno) {
            ...
            case \CURLE_OPERATION_TIMEOUTED:
                $msg = "Could not connect to SimplePay\Vendor\Stripe ({$url}).  Please check your "
     ...
     * @param int $errno
     * @param int $rcode
     * @param array|\SimplePay\Vendor\Stripe\Util\CaseInsensitiveArray $rheaders
     * @param int $numRetries
     *
     * @return bool
     */
    ...
    private function canSafelyUseHttp2()
    {
        ...
        // (cf. https://github.com/curl/curl/issues/2416), which SimplePay\Vendor\Stripe use.
