 ...
 * refunded to the SimplePay\Vendor\Stripe account from which the fee was originally collected.
 *
 * Related guide: <a
 ...
 * @property string|\SimplePay\Vendor\Stripe\ApplicationFee $fee ID of the application fee that was refunded.
...
class ApplicationFeeRefund extends ApiResource
{
    ...
    /**
     * @return string the API URL for this SimplePay\Vendor\Stripe refund
     */
