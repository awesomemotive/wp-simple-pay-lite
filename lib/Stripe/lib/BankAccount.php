 ...
 * @property null|string|\SimplePay\Vendor\Stripe\Account $account The ID of the account that the bank account is associated with.
 ...
 * @property null|string|\SimplePay\Vendor\Stripe\Customer $customer The ID of the customer that the bank account is associated with.
 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $future_requirements Information about the <a href="https://stripe.com/docs/connect/custom-accounts/future-requirements">upcoming new requirements for the bank account</a>, including what information needs to be collected, and by when.
...
class BankAccount extends ApiResource
{
     ...
     *
     * @return \SimplePay\Vendor\Stripe\BankAccount the deleted resource
     */
