 ...
 * represent a customer's payment instrument, and can be used with the SimplePay\Vendor\Stripe API
 * just like a <code>Card</code> object: once chargeable, they can be charged, or can be
 * attached to customers.
 *
 * SimplePay\Vendor\Stripe doesn't recommend using the deprecated <a href="https://stripe.com/docs/api/sources">Sources API</a>.
 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $ach_credit_transfer
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $ach_debit
 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $code_verification
 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $receiver
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $redirect
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $sepa_credit_transfer
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $sepa_debit
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $sofort
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $source_order
 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $three_d_secure
...
class Source extends ApiResource
{
     ...
     *
     * @return \SimplePay\Vendor\Stripe\Source the created resource
     */
     ...
     * creation request and SimplePay\Vendor\Stripe will return the corresponding up-to-date source
     * object information.
     *
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Source the updated resource
     */
     ...
     * @param null|array|string $opts
     *
     * @throws \SimplePay\Vendor\Stripe\Exception\UnexpectedValueException if the source is not attached to a customer
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Source the detached source
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\SourceTransaction> list of source transactions
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Source the verified source
     */
