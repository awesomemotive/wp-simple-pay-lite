...
namespace SimplePay\Vendor\Stripe\Apps;

/**
 * Secret Store is an API that allows SimplePay\Vendor\Stripe Apps developers to securely persist secrets for use by UI Extensions and app backends.
 *
 ...
 * @property \SimplePay\Vendor\Stripe\StripeObject $scope
 */
class Secret extends \SimplePay\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \SimplePay\Vendor\Stripe\Apps\Secret the created resource
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\Apps\Secret> of ApiResources
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Apps\Secret the deleted secret
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Apps\Secret the finded secret
     */
