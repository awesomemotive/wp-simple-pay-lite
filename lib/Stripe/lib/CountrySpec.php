...
/**
 * SimplePay\Vendor\Stripe needs to collect certain pieces of information about each account
 ...
 * @property \SimplePay\Vendor\Stripe\StripeObject $supported_bank_account_currencies Currencies that can be accepted in the specific country (for transfers).
 ...
 * @property \SimplePay\Vendor\Stripe\StripeObject $verification_fields
 */
class CountrySpec extends ApiResource
{
     ...
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\CountrySpec> of ApiResources
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\CountrySpec
     */
