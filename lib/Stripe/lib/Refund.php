 ...
 * @property null|string|\SimplePay\Vendor\Stripe\Charge $charge ID of the charge that's refunded.
 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $destination_details
 * @property null|string|\SimplePay\Vendor\Stripe\BalanceTransaction $failure_balance_transaction After the refund fails, this balance transaction describes the adjustment made on your account balance that reverses the initial balance transaction.
 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $next_action
 * @property null|string|\SimplePay\Vendor\Stripe\PaymentIntent $payment_intent ID of the PaymentIntent that's refunded.
 * @property null|string $reason Reason for the refund, which is either user-provided (<code>duplicate</code>, <code>fraudulent</code>, or <code>requested_by_customer</code>) or generated by SimplePay\Vendor\Stripe internally (<code>expired_uncaptured_charge</code>).
 * @property null|string $receipt_number This is the transaction number that appears on email receipts sent for this refund.
 * @property null|string|\SimplePay\Vendor\Stripe\TransferReversal $source_transfer_reversal The transfer reversal that's associated with the refund. Only present if the charge came from another SimplePay\Vendor\Stripe account.
 ...
 * @property null|string|\SimplePay\Vendor\Stripe\TransferReversal $transfer_reversal This refers to the transfer reversal object if the accompanying transfer reverses. This is only applicable if the charge was created using the destination parameter.
 */
class Refund extends ApiResource
{
     ...
     *
     * @return \SimplePay\Vendor\Stripe\Refund the created resource
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\Refund> of ApiResources
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Refund the updated resource
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Refund the canceled refund
     */
