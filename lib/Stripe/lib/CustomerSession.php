 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $components Configuration for the components supported by this Customer Session.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string|\SimplePay\Vendor\Stripe\Customer $customer The Customer the Customer Session was created for.
...
class CustomerSession extends ApiResource
{
     ...
     *
     * @return \SimplePay\Vendor\Stripe\CustomerSession the created resource
     */
