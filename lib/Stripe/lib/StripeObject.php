...
class StripeObject implements \ArrayAccess, \Countable, \JsonSerializable
{
    ...
    public function &__get($k)
    {
        ...
        if (!empty($this->_transientValues) && $this->_transientValues->includes($k)) {
            ...
            $message = "SimplePay\Vendor\Stripe Notice: Undefined property of {$class} instance: {$k}. "
        ...
        $class = static::class;
        Stripe::getLogger()->error("SimplePay\Vendor\Stripe Notice: Undefined property of {$class} instance: {$k}");
     ...
     * SimplePay\Vendor\Stripe object.
     *
    ...
    /**
     * Returns a pretty JSON representation of the SimplePay\Vendor\Stripe object.
     *
     * @return string the JSON representation of the SimplePay\Vendor\Stripe object
     */
    ...
    /**
     * @return null|ApiResponse The last response from the SimplePay\Vendor\Stripe API
     */
    ...
    /**
     * Sets the last response from the SimplePay\Vendor\Stripe API.
     *
