 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $document Result from a document check
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $email Result from a email check
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $id_number Result from an id_number check
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $options
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $phone Result from a phone check
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $selfie Result from a selfie check
 ...
 */
class VerificationReport extends \SimplePay\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\Identity\VerificationReport> of ApiResources
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Identity\VerificationReport
     */
