 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $owner The account or customer the tax ID belongs to.
...
class TaxId extends ApiResource
{
     ...
     *
     * @return \SimplePay\Vendor\Stripe\TaxId the created resource
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\TaxId the deleted resource
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\TaxId> of ApiResources
     */
