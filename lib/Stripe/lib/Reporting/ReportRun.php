...
namespace SimplePay\Vendor\Stripe\Reporting;

/**
 * The Report Run object represents an instance of a report type generated with
 * specific run parameters. Once the object is created, SimplePay\Vendor\Stripe begins processing the report.
 ...
 * @property \SimplePay\Vendor\Stripe\StripeObject $parameters
 ...
 * @property null|\SimplePay\Vendor\Stripe\File $result The file object representing the result of the report run (populated when <code>status=succeeded</code>).
 ...
 */
class ReportRun extends \SimplePay\Vendor\Stripe\ApiResource
{
