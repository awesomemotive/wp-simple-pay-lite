 ...
 * @property \SimplePay\Vendor\Stripe\StripeObject $balance_impact Change to a FinancialAccount's balance
 ...
 * @property null|\SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\Treasury\TransactionEntry> $entries A list of TransactionEntries that are part of this Transaction. This cannot be expanded in any list endpoints.
 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $flow_details Details of the flow that created the Transaction.
...
class Transaction extends \SimplePay\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\Treasury\Transaction> of ApiResources
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Treasury\Transaction
     */
