 ...
 * @property \SimplePay\Vendor\Stripe\StripeObject $capabilities
 * @property bool $charges_enabled Whether the account can create live charges.
 * @property \SimplePay\Vendor\Stripe\StripeObject $company
 * @property \SimplePay\Vendor\Stripe\StripeObject $controller
 ...
 * @property string $default_currency Three-letter ISO currency code representing the default currency for the account. This must be a currency that <a href="https://stripe.com/docs/payouts">SimplePay\Vendor\Stripe supports in the account's country</a>.
 ...
 * @property bool $payouts_enabled Whether SimplePay\Vendor\Stripe can send payouts to this account.
 * @property \SimplePay\Vendor\Stripe\StripeObject $requirements
 ...
 * @property \SimplePay\Vendor\Stripe\StripeObject $tos_acceptance
 * @property string $type The SimplePay\Vendor\Stripe account type. Can be <code>standard</code>, <code>express</code>, or <code>custom</code>.
 */
