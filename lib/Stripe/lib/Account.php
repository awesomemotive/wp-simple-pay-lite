...
/**
 * This is an object representing a SimplePay\Vendor\Stripe account. You can retrieve it to see
 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $business_profile Business information about the account.
 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $capabilities
 * @property null|bool $charges_enabled Whether the account can create live charges.
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $company
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $controller
 ...
 * @property null|string $default_currency Three-letter ISO currency code representing the default currency for the account. This must be a currency that <a href="https://stripe.com/docs/payouts">SimplePay\Vendor\Stripe supports in the account's country</a>.
 * @property null|bool $details_submitted Whether account details have been submitted. Accounts with SimplePay\Vendor\Stripe Dashboard access, which includes Standard accounts, cannot receive payouts before this is true. Accounts where this is false should be directed to <a href="/connect/onboarding">an onboarding flow</a> to finish submitting account details.
 * @property null|string $email An email address associated with the account. It's not used for authentication and SimplePay\Vendor\Stripe doesn't market to this field without explicit approval from the platform.
 ...
 * @property null|bool $payouts_enabled Whether SimplePay\Vendor\Stripe can send payouts to this account.
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $requirements
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $settings Options for customizing how the account functions within Stripe.
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $tos_acceptance
 * @property null|string $type The SimplePay\Vendor\Stripe account type. Can be <code>standard</code>, <code>express</code>, <code>custom</code>, or <code>none</code>.
 */
class Account extends ApiResource
{
    ...
    /**
     * With <a href="/docs/connect">Connect</a>, you can create SimplePay\Vendor\Stripe accounts for
     ...
     *
     * @return \SimplePay\Vendor\Stripe\Account the created resource
     */
     ...
     *
     * Live-mode accounts where SimplePay\Vendor\Stripe is responsible for negative account balances
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Account the deleted resource
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\Account> of ApiResources
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Account the updated resource
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Account
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\StripeObject object containing the response from the API
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Account the rejected account
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\Capability> the list of capabilities
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Capability
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\BankAccount|\SimplePay\Vendor\Stripe\Card> the list of external accounts (BankAccount or Card)
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\BankAccount|\SimplePay\Vendor\Stripe\Card
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\LoginLink
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\Person> the list of persons
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Person
     */
