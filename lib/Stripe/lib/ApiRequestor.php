...
class ApiRequestor
{
     ...
     * @static
     *
     * @param string     $apiKey the SimplePay\Vendor\Stripe API key, to be used in regular API requests
     * @param null       $clientInfo client user agent information
     * @param null       $appInfo information to identify a plugin that integrates SimplePay\Vendor\Stripe using this library
     * @param 'v1'|'v2' $apiMode
     *
     * @return array
     */
    ...
    private function _prepareRequest($method, $url, $params, $headers, $apiMode)
    {
        ...
        if (!$myApiKey) {
            $msg = 'No API key provided.  (HINT: set your API key using '
                ...
                . 'the SimplePay\Vendor\Stripe web interface.  See https://stripe.com/api for '
