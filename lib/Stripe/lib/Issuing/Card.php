 ...
 * @property null|string|\SimplePay\Vendor\Stripe\Issuing\PersonalizationDesign $personalization_design The personalization design object belonging to this card.
 * @property null|string|\SimplePay\Vendor\Stripe\Issuing\Card $replaced_by The latest card that replaces this card, if any.
 * @property null|string|\SimplePay\Vendor\Stripe\Issuing\Card $replacement_for The card this card replaces, if any.
 * @property null|string $replacement_reason The reason why the previous card needed to be replaced.
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $shipping Where and how the card will be shipped.
 * @property \SimplePay\Vendor\Stripe\StripeObject $spending_controls
 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $wallets Information relating to digital wallets (like Apple Pay and Google Pay).
 */
class Card extends \SimplePay\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \SimplePay\Vendor\Stripe\Issuing\Card the created resource
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\Issuing\Card> of ApiResources
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Issuing\Card the updated resource
     */
