 ...
 * @property \SimplePay\Vendor\Stripe\BalanceTransaction[] $balance_transactions List of balance transactions associated with this authorization.
 * @property \SimplePay\Vendor\Stripe\Issuing\Card $card You can <a href="https://stripe.com/docs/issuing/cards">create physical or virtual cards</a> that are issued to cardholders.
 * @property null|string|\SimplePay\Vendor\Stripe\Issuing\Cardholder $cardholder The cardholder to whom this authorization belongs.
 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $fleet Fleet-specific information for authorizations using Fleet cards.
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $fuel Information about fuel that was purchased with this transaction. Typically this information is received from the merchant after the authorization has been approved and the fuel dispensed.
...
class Authorization extends \SimplePay\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\Issuing\Authorization> of ApiResources
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Issuing\Authorization the updated resource
     */
