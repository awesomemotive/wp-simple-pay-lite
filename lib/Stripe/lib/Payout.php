 ...
 * href="/docs/connect/bank-debit-card-payouts">connected SimplePay\Vendor\Stripe account</a>. You
 ...
 * @property null|string|\SimplePay\Vendor\Stripe\BankAccount|\SimplePay\Vendor\Stripe\Card $destination ID of the bank account or card the payout was sent to.
 * @property null|string|\SimplePay\Vendor\Stripe\BalanceTransaction $failure_balance_transaction If the payout failed or was canceled, this will be the ID of the balance transaction that reversed the initial balance transaction, and puts the funds from the failed payout back in your balance.
 ...
 * @property null|string|\SimplePay\Vendor\Stripe\Payout $reversed_by If the payout was reversed, this is the ID of the payout that reverses this payout.
