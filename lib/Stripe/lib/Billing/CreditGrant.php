...
namespace SimplePay\Vendor\Stripe\Billing;
 ...
 * @property \SimplePay\Vendor\Stripe\StripeObject $amount
 * @property \SimplePay\Vendor\Stripe\StripeObject $applicability_config
 * @property string $category The category of this credit grant.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string|\SimplePay\Vendor\Stripe\Customer $customer Id of the customer to whom the credit was granted.
 ...
 * @property null|string|\SimplePay\Vendor\Stripe\TestHelpers\TestClock $test_clock ID of the test clock this credit grant belongs to.
 ...
 */
class CreditGrant extends \SimplePay\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \SimplePay\Vendor\Stripe\Billing\CreditGrant the created resource
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\Billing\CreditGrant> of ApiResources
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Billing\CreditGrant the updated resource
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Billing\CreditGrant the expired credit grant
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Billing\CreditGrant the voided credit grant
     */
