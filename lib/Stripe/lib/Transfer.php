...
/**
 * A <code>Transfer</code> object is created when you move funds between SimplePay\Vendor\Stripe accounts as
 * part of Connect.
 *
 * Before April 6, 2017, transfers also represented movement of funds from a
 * SimplePay\Vendor\Stripe account to a card or bank account. This behavior has since been split
 ...
 * @property null|string|\SimplePay\Vendor\Stripe\BalanceTransaction $balance_transaction Balance transaction that describes the impact of this transfer on your account balance.
 ...
 * @property null|string|\SimplePay\Vendor\Stripe\Account $destination ID of the SimplePay\Vendor\Stripe account the transfer was sent to.
 * @property null|string|\SimplePay\Vendor\Stripe\Charge $destination_payment If the destination is a SimplePay\Vendor\Stripe account, this will be the ID of the payment that the destination account received for the transfer.
 ...
 * @property null|string|\SimplePay\Vendor\Stripe\Charge $source_transaction ID of the charge that was used to fund the transfer. If null, the transfer was funded from the available balance.
...
class Transfer extends ApiResource
{
     ...
     *
     * @return \SimplePay\Vendor\Stripe\Transfer the created resource
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\Transfer> of ApiResources
     */
     ...
     * from either a transfer creation request or the transfer list, and SimplePay\Vendor\Stripe will
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Transfer the updated resource
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\TransferReversal
     */
