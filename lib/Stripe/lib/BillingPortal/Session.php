...
namespace SimplePay\Vendor\Stripe\BillingPortal;
 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $flow Information about a specific flow for the customer to go through. See the <a href="https://stripe.com/docs/customer-management/portal-deep-links">docs</a> to learn more about using customer portal deep links and flows.
...
class Session extends \SimplePay\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \SimplePay\Vendor\Stripe\BillingPortal\Session the created resource
     */
