 ...
 * @property null|string|\SimplePay\Vendor\Stripe\Charge $charge The charge associated with this review.
 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $ip_address_location Information related to the location of the payment. Note that this information is an approximation and attempts to locate the nearest population center - it should not be used to determine a specific address.
 ...
 * @property null|string|\SimplePay\Vendor\Stripe\PaymentIntent $payment_intent The PaymentIntent ID associated with this review, if one exists.
 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $session Information related to the browsing session of the user who initiated the payment.
 */
class Review extends ApiResource
{
     ...
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\Review> of ApiResources
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Review
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Review the approved review
     */
