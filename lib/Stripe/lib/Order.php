 ...
 * @property null|(string|\SimplePay\Vendor\Stripe\Discount)[] $discounts The discounts applied to the order. Use <code>expand[]=discounts</code> to expand each discount.
 * @property null|string $ip_address A recent IP address of the purchaser used for tax reporting and tax location inference.
 * @property \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\LineItem> $line_items A list of line items the customer is ordering. Each line item includes information about the product, the quantity, and the resulting cost. There is a maximum of 100 line items.
 ...
 * @property \SimplePay\Vendor\Stripe\StripeObject $payment
 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $shipping_details Customer shipping information associated with the order.
 * @property string $status The overall status of the order.
 * @property \SimplePay\Vendor\Stripe\StripeObject $tax_details
...
class Order extends ApiResource
{
     ...
     *
     * @return \SimplePay\Vendor\Stripe\Order the canceled order
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Order the reopened order
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Order the submited order
     */
