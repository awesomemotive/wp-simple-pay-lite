 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $delivery_estimate The estimated range for how long shipping will take, meant to be displayable to the customer. This will appear on CheckoutSessions.
 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $fixed_amount
 ...
 * @property null|string|\SimplePay\Vendor\Stripe\TaxCode $tax_code A <a href="https://stripe.com/docs/tax/tax-categories">tax code</a> ID. The Shipping tax code is <code>txcd_92010001</code>.
...
class ShippingRate extends ApiResource
{
     ...
     *
     * @return \SimplePay\Vendor\Stripe\ShippingRate the created resource
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\ShippingRate> of ApiResources
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\ShippingRate the updated resource
     */
