...
/**
 * <code>ExchangeRate</code> objects allow you to determine the rates that SimplePay\Vendor\Stripe is currently
 ...
 * - <em>reconcile SimplePay\Vendor\Stripe transactions</em>
 * - <em>determine how much money to send to a connected account</em>
 * - <em>determine app fees to charge a connected account</em>
 *
 * <em>Using this Exchange Rates API beta for any purpose other than to transact on SimplePay\Vendor\Stripe is strictly prohibited and constitutes a violation of Stripe's terms of service.</em>
 *
 ...
 * @property \SimplePay\Vendor\Stripe\StripeObject $rates Hash where the keys are supported currencies and the values are the exchange rate at which the base id currency converts to the key currency.
 */
class ExchangeRate extends ApiResource
{
     ...
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\ExchangeRate> of ApiResources
     */
