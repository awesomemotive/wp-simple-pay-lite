...
/**
 * Tokenization is the process SimplePay\Vendor\Stripe uses to collect sensitive card or bank
...
class Token extends ApiResource
{
     ...
     *
     * @return \SimplePay\Vendor\Stripe\Token the created resource
     */
