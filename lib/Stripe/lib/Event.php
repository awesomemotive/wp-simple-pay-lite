 ...
 * @property null|string $api_version The SimplePay\Vendor\Stripe API version used to render <code>data</code>. <em>Note: This property is populated only for events on or after October 31, 2014</em>.
 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $request Information on the API request that instigated the event.
