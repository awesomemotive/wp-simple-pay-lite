 ...
 * @property null|string $api_version The SimplePay\Vendor\Stripe API version used to render <code>data</code>. This property is populated only for events on or after October 31, 2014.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property \SimplePay\Vendor\Stripe\StripeObject $data
 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $request Information on the API request that triggers the event.
...
class Event extends ApiResource
{
     ...
     * SimplePay\Vendor\Stripe API version at its creation time, specified in <a
     * href="https://docs.stripe.com/api/events/object">event object</a>
     * <code>api_version</code> attribute (not according to your current SimplePay\Vendor\Stripe API
     ...
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\Event> of ApiResources
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Event
     */
