 ...
 * (to minimize per-transaction fees), or for having SimplePay\Vendor\Stripe tabulate your usage-based billing totals.
 *
 ...
 * @property string|\SimplePay\Vendor\Stripe\Customer $customer The ID of the customer who will be billed when this invoice item is billed.
 ...
 * @property null|(string|\SimplePay\Vendor\Stripe\Discount)[] $discounts The discounts which apply to the invoice item. Item discounts are applied before invoice discounts. Use <code>expand[]=discounts</code> to expand each discount.
 * @property null|string|\SimplePay\Vendor\Stripe\Invoice $invoice The ID of the invoice this invoice item belongs to.
 ...
 * @property null|\SimplePay\Vendor\Stripe\Plan $plan If the invoice item is a proration, the plan of the subscription that the proration was computed for.
 * @property null|\SimplePay\Vendor\Stripe\Price $price The price of the invoice item.
 ...
 * @property null|string|\SimplePay\Vendor\Stripe\Subscription $subscription The subscription that this invoice item has been created for, if any.
 * @property null|string $subscription_item The subscription item that this invoice item has been created for, if any.
 * @property null|\SimplePay\Vendor\Stripe\TaxRate[] $tax_rates The tax rates which apply to the invoice item. When set, the <code>default_tax_rates</code> on the invoice do not apply to this invoice item.
 * @property null|string|\SimplePay\Vendor\Stripe\TestHelpers\TestClock $test_clock ID of the test clock this invoice item belongs to.
...
class InvoiceItem extends ApiResource
{
     ...
     *
     * @return \SimplePay\Vendor\Stripe\InvoiceItem the created resource
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\InvoiceItem the deleted resource
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\InvoiceItem> of ApiResources
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\InvoiceItem the updated resource
     */
