 ...
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $account_holder The account holder that this account belongs to.
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $balance The most recent information about the account's balance.
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $balance_refresh The state of the most recent attempt to refresh the account balance.
 ...
 * @property null|string|\SimplePay\Vendor\Stripe\FinancialConnections\AccountOwnership $ownership The most recent information about the account's owners.
 * @property null|\SimplePay\Vendor\Stripe\StripeObject $ownership_refresh The state of the most recent attempt to refresh the account owners.
...
class Account extends \SimplePay\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \SimplePay\Vendor\Stripe\Collection<\SimplePay\Vendor\Stripe\FinancialConnections\Account> of ApiResources
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\FinancialConnections\Account
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\FinancialConnections\Account the disconnected account
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\FinancialConnections\Account the refreshed account
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\FinancialConnections\Account the subscribed account
     */
     ...
     * @throws \SimplePay\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimplePay\Vendor\Stripe\FinancialConnections\Account the unsubscribed account
     */
