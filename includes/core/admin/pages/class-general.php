				...
				if ( 'general' == $section ) {
					...
					$fields[ $section ] = array(
						...
						'cancelled_page' => array(
							'title'       => esc_html__( 'Payment Cancelled Page', 'stripe' ),
							'type'        => 'select',
							...
							'class'       => array( 'simpay-chosen-search' ),
							'default'     => $failure_default,
							'description' => esc_html__( 'The page customers are sent to after a cancelling a Stripe.com Checkout Session.', 'stripe' ),
						),
					);
