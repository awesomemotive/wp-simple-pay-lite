...
// ***SIMPLE PAY EDIT***: Check for existence of main class in case the original
// Native PHP Sessions (Patheon Sessions) is active and/or it's already included in another plugin.
...
class Pantheon_Sessions {
	...
	private function require_files() {
		...
		// ***SIMPLE PAY EDIT***: Check for existence of admin class file in case it's not included.
