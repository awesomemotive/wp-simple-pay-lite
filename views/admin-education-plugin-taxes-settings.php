...
<div class="simpay-landing-zone">
	...
	<h2 class="simpay-landing-zone__title">
		<?php esc_html_e( '💸 Collect Taxes and Additional Fees', 'stripe' ); ?>
	</h2>
	...
	<section class="simpay-landing-zone__screenshot">
		<div class="simpay-landing-zone__screenshot-img">
			<img src="<?php echo esc_url( SIMPLE_PAY_INC_URL . 'core/assets/images/settings/taxes-thumb.png' ); ?>" alt="<?php echo esc_attr__( 'Tax settings', 'stripe' ); ?>" />
			<a href="<?php echo esc_url( SIMPLE_PAY_INC_URL . 'core/assets/images/settings/taxes-full.png' ); ?>" class="hover" data-lity></a>
		</div>
