...
<div class="simpay-landing-zone">
	...
	<section class="simpay-landing-zone__screenshot">
		<div class="simpay-landing-zone__screenshot-img">
			<img src="<?php echo esc_url( SIMPLE_PAY_INC_URL . 'core/assets/images/settings/email-thumb.png' ); ?>" alt="<?php echo esc_attr__( 'Payment Receipt settings', 'stripe' ); ?>" />
			<a href="<?php echo esc_url( SIMPLE_PAY_INC_URL . 'core/assets/images/settings/email-full.png' ); ?>" class="hover" data-lity></a>
		</div>
