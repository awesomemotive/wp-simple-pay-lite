...
<div id="sc-install-notice" class="updated">
	<p>
		...
		<a href="<?php echo add_query_arg( 'page', $this->base->plugin_slug, admin_url( 'admin.php' ) ); ?>" class="button-primary"><?php _e( 'Get started by entering your Stripe keys', 'sc' ); ?></a>
