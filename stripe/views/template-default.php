<div class="sc-admin-hidden" id="default-settings-tab">
	<form method="post" action="#default-settings" id="default-settings">
		...
		<div>
			<label for="<?php echo $sc_options->get_setting_id( 'name' ); ?>"><?php _e( 'Site Name', 'sc' ); ?></label>
			<?php 
		...
		<div>
			<label for="<?php echo $sc_options->get_setting_id( 'currency' ); ?>"><?php _e( 'Currency', 'sc' ); ?></label>
			<?php
		...
		<div>
			<label for="<?php echo $sc_options->get_setting_id( 'image_url' ); ?>"><?php _e( 'Image URL', 'sc' ); ?></label>
			<?php 
		...
		<div>
			<label for="<?php echo $sc_options->get_setting_id( 'checkout_button_label' ); ?>"><?php _e( 'Checkout Button Label', 'sc' ); ?></label>
			<?php 
		...
		<div>
			<label for="<?php echo $sc_options->get_setting_id( 'payment_button_label' ); ?>"><?php _e( 'Payment Button Label', 'sc' ); ?></label>
			<?php 
		...
		<div>
			<label for="<?php echo $sc_options->get_setting_id( 'success_redirect_url' ); ?>"><?php _e( 'Success Redirect URL', 'sc' ); ?></label>
			<?php 
		...
		<div>
			<label for="<?php echo $sc_options->get_setting_id( 'disable_success_message' ); ?>"><?php _e( 'Disable Success Message', 'sc' ); ?></label>
		...
		<div>
			<label for="<?php echo $sc_options->get_setting_id( 'failure_redirect_url' ); ?>"><?php _e( 'Failure Redirect URL', 'sc' ); ?></label>
			<p class="description">
		...
		<div>
			<label for="<?php echo $sc_options->get_setting_id( 'billing' ); ?>"><?php _e( 'Billing', 'sc' ); ?></label>
			<?php $sc_options->checkbox( 'billing' ); ?>
			<span><?php _e( 'Require the user to enter their billing address during checkout.', 'sc' ); ?></span>
		</div>

		<div>
			<label for="<?php echo $sc_options->get_setting_id( 'verify_zip' ); ?>"><?php _e( 'Verify Zip', 'sc' ); ?></label>
			<?php $sc_options->checkbox( 'verify_zip' ); ?>
			<span><?php _e( 'Verifies the zip code of the card.', 'sc' ); ?></span>
		</div>

		<div>
			<label for="<?php echo $sc_options->get_setting_id( 'enable_remember' ); ?>"><?php _e( 'Enable Remember', 'sc' ); ?></label>
		...
		<div>
			<label for="<?php echo $sc_options->get_setting_id( 'disable_css' ); ?>"><?php _e( 'Disable CSS', 'sc' ); ?></label>
			<?php $sc_options->checkbox( 'disable_css' ); ?>
			<span><?php _e( 'Disable the plugin from ouputting the default form CSS.', 'sc' ); ?></span>
		</div>

		<div>
			<label for="<?php echo $sc_options->get_setting_id( 'always_enqueue' ); ?>"><?php _e( 'Always Enqueue', 'sc' ); ?></label>
		...
		<div>
			<label for="<?php echo $sc_options->get_setting_id( 'uninstall_save_settings' ); ?>"><?php _e( 'Save Settings', 'sc' ); ?></label>
