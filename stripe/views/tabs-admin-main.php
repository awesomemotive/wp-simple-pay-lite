<div class="tab-content" id="stripe-keys-settings-tab">
	<!--<form method="post" action="#stripe-keys-settings" id="stripe-keys-settings">-->
		<?php
			...
			/*if( isset( $_POST['sc_save_all'] ) ) {
				echo '<pre>' . print_r( $_POST, true ) . '</pre>';
			}*/
			
			$saved = get_option( $sc_options->get_option() );
			
			echo '<pre>' . $sc_options->get_option() . '<br>' . print_r( $saved, true ) . '</pre>';
		?>
		...
		<?php submit_button( 'Save Settings', 'primary', 'sc_save_all' ); ?>
	<!--</form>-->
</div>
